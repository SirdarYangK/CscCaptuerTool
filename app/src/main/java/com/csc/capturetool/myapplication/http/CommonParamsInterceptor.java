...
public class CommonParamsInterceptor implements Interceptor {
    ...
    private Request injectParamsIntoUrl(Request request, Request.Builder requestBuilder, Map<String, Object> paramsMap) {
...
//            interceptor.paramsMap.putAll(StringUtils.compare(paramsMap));
...
//            interceptor.queryParamsMap.putAll(StringUtils.compare(queryParamsMap));
